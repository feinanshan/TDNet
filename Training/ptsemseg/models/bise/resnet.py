...
def Resnet18(pretrained=True, norm_layer=None, **kwargs):
    model = ResNet(BasicBlock, [2, 2, 2, 2],[1, 2, 2, 2], norm_layer=norm_layer)
    if pretrained:
...
def Resnet34(pretrained=True, norm_layer=None, **kwargs):
    model = ResNet(BasicBlock, [3, 4, 6, 3],[1, 2, 2, 2], norm_layer=norm_layer)
    if pretrained:
...
def Resnet50(pretrained=True, norm_layer=None, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],[1, 2, 2, 2], norm_layer=norm_layer)
    if pretrained:
...
def Resnet101(pretrained=True, norm_layer=None, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 23, 3],[1, 2, 2, 2], norm_layer=norm_layer)
    if pretrained:
...
def Resnet152(pretrained=True, norm_layer=None, **kwargs):
    model = ResNet(Bottleneck, [3, 8, 36, 3],[1, 2, 2, 2], norm_layer=norm_layer)
    if pretrained:
